...
linekey.6.label = %NULL%
linekey.6.extension = %NULL%
linekey.6.xml_phonebook = %NULL%
linekey.6.pickup_value = %NULL%
linekey.7.type = 15
linekey.7.line = 1
linekey.7.value = %NULL%
linekey.7.label = %NULL%
linekey.7.extension = %NULL%
linekey.7.xml_phonebook = %NULL%
linekey.7.pickup_value = %NULL%
